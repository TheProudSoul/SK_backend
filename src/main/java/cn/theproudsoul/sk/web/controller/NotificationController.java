...
import cn.theproudsoul.sk.web.vo.ListRequestVo;
...
@Slf4j
@RestController
@RequestMapping(ControllerPath.NOTIFICATION)
public class NotificationController {
    ...
    public DeferredResult<List<FileJournalVo>> list(HttpServletRequest request, @PathVariable long user, @RequestParam long journalId) {
        ...
        final DeferredResult<List<FileJournalVo>> result = new DeferredResult(8000L, Collections.emptyList());
